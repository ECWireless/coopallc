...
// Components
import { Card, Line, Transform } from '../components';
            ...
            <Col2>
              <Col2Left align={'center'} justify={'flex-start'}>
                <Fade bottom ssrFadeout>
                  ...
                  <Box3 width={360} marginTop={30}>
                    <P2 align={'center'}>
                      We work with our clients 1-on-1 to get your branding just
                      right.
                    </P2>
                  </Box3>
                </Fade>
              ...
              <Col2Right align={'center'} justify={'flex-start'}>
                <Fade delay={500} bottom ssrFadeout>
                  ...
                  <Box3 width={360} marginTop={30}>
                    <P2 align={'center'}>
                      Our frameworks are modern, flexible, and always fast.
                    </P2>
                  </Box3>
                </Fade>
              </Col2Right>
            ...
            <Col2>
              <Col2Left align={'center'} justify={'flex-start'}>
                <Fade bottom ssrFadeout>
                  ...
                  <Box3 width={350} marginTop={30}>
                    <P2 align={'center'}>
                      Custom CMS configuration is available for any projects
                      that need consistently updated or maintained content.
                    </P2>
                  </Box3>
                </Fade>
              </Col2Left>
              <Col2Right align={'center'} justify={'flex-start'}>
                <Fade delay={500} bottom ssrFadeout>
                  ...
                  <Box3 width={350} marginTop={30}>
                    <P2 align={'center'}>
                      Our websites are always shipped with a Google Lighthouse
                      score above 95%.
                    </P2>
                  </Box3>
                </Fade>
