          ...
          <Fade bottom ssrFadeout>
            <Box marginTop={50} marginBottom={100}>
              <P2 center color={colors.white}>
                Get a part-time Web Developer at the cost of a subscription
              </P2>
            </Box>
          </Fade>
          <Box marginTop={50} marginBottom={100}>
              ...
              <Fade ssrFadeout>
                <Col2Left align={'center'} justify={'center'}>
                  <SubscriptionCard
                    ...
                    description={
                      'Websites built for personal galleries, freelancers, and soloprenuers.'
                    }
                    subscriptionCost={'$20'}
                    paymentCost={'$50'}
                    hoursPerMonth={'10'}
              ...
              <Fade delay={200} ssrFadeout>
                <Col2Right align={'center'} justify={'center'}>
                  <SubscriptionCard
                    ...
                    description={
                      'Websites built for e-commerce stores, agencies, real estate, startups, and more.'
                    }
                    subscriptionCost={'$30'}
                    paymentCost={'$100'}
                    hoursPerMonth={'20'}
...
const AccentObject3 = styled.div`
  ...
  width: 15rem;
  background: ${colors.yellow};
  transform: translate(-8rem, 0.2rem) rotate(-30deg);
  opacity: 0.75;
  z-index: 1;
`;
