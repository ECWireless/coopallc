              ...
              <Box2 width={400} marginTop={50}>
                <Fade ssrFadeout bottom delay={200}>
                  <P3 center color={colors.black}>
                    <strong>Parish Digital</strong> is full-service video
                    production studio offering virtual event production, video
                    editing, and multimedia presentations.
                  </P3>
                </Fade>
              </Box2>
            </Col2Left>
          ...
          <Box marginTop={100}>
            <Col2Right align={'center'} justify={'center'}>
              ...
              <Box2 width={400} marginTop={50}>
                <Fade ssrFadeout bottom delay={200}>
                  <P3 center color={colors.black}>
                    <strong>Abraham Home Care</strong> provides home care
                    services to 30 patients and employs a team of over 50 direct
                    care workers.
                  </P3>
                </Fade>
              </Box2>
          ...
          <Box marginTop={100}>
            <Col2Left align={'center'} justify={'center'}>
              ...
              <Box2 width={400} marginTop={50}>
                <Fade ssrFadeout bottom delay={200}>
                  <P3 center color={colors.black}>
                    <strong>StudioME</strong> provides media creators access to
                    user-friendly studio spaces, equipment rentals, editing
                    workstations, and custom production services.
                  </P3>
                </Fade>
              </Box2>
            </Col2Left>
          ...
          <Box marginTop={100}>
            <Col2Right align={'center'} justify={'center'}>
              ...
              <Box2 width={400} marginTop={50}>
                <Fade ssrFadeout bottom delay={200}>
                  <P3 center color={colors.black}>
                    <strong>Mosebach Resistors Company</strong> specializes in
                    AC and DC Load Banks of any size, both portable and
                    stationary.
                  </P3>
                </Fade>
              </Box2>
